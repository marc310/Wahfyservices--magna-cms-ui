...
<div>
      ...
      <div class="scroll_bar bullets">
       ...
       <div>
         ...
         <a class="dot"  href="#s2"></a>
         <a class="dot"  href="#s3"></a>
         <a class="dot"  href="#s4"></a>
         <a class="dot"  href="#s5"></a>
...
.CSSgal {
	...
	overflow: hidden;
	height: 0% !important; /* Or set a fixed height */
}
...
<div class="CSSgal">
  ...
  <div class="slider">
    <div class="slid active">
              <section id="slide_1" class="Hero-sction" style="padding:0px; margin:0px;">
        <div class="Hero-intro">
          <div id="section1" class="hero-conatiner section">
            <div class="hero-content top-[22rem] relative mr-16 z-30" dir="rtl">
              <h1 class="text-white text-5xl" style="text-align:right;" id="intro-frame">وجهتك لابتكار</h1>
    ...
    <div  class="slid">
      <section id="slide_2" class="bussiness-Discription">
        <div class="splide">
...
<ul class="splide__list section" id="section2">
    ...
    <div  class="slid">
      <section class="policy-container section" id="slide_3">
		...
		<div  class="slid">
      <section id="slide_4" class="booking-container" wire:ignore.self>
...
@endif
  ...
  <div  class="slid">
      ...
      <section id="slide_5" class="subscribtion">
...
$(document).ready(function() {
          ...
          const slides = document.querySelectorAll('.slid');
            ...
            const currentPage = document.querySelector('.slid.active');
  const currentPageIndex = Array.from(slides).indexOf(currentPage);
  let nextPageIndex;
...
//   alert(o);
        ...
        if(o == 0){
            ...
            $(this).css("transform", 'translateX(-400%)');
        }else{
            $(this).css("transform", 'translateX(0%)');
        }
