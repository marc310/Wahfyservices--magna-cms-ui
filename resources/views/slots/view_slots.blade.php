        ...
        <div class="col-xl-12">
            <div class="card mb-4">
                <div class="card-header">
                  ...
                  <div class="row">
                    <div class="col-md-4">
                     <span> فترات العمل الخاصة بتاريخ  </span>
                     <h2>{{$Appointment->indexing}}</h2>
                    </div>
    ...
    <div class="card">
      <div class="mb-4">
        <div class="card-header">
            ...
            فترات عمل الخاصة باليوم ({{$Appointment->appointment_day}}) والموافق تاريخ  ({{$Appointment->indexing}})
        </div>
            ...
            <table class="table table-striped" id="ex_datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $Days_Slots_all->date_of_day}}</td>
